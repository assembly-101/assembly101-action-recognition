...
def get_parser():
    ...
    parser.add_argument('--assume-yes', default=True, help='Say yes to every prompt')
    parser.add_argument('--half', default=False, help='Use half-precision (FP16) training')

    parser.add_argument('--model_saved_name', default='')
    parser.add_argument('--config', default='mssh_test_joint_toy_ms.yaml',help='path to the configuration file') # MSSh: changed config file
        ...
        with torch.no_grad():
            ...
            for ln in loader_name:
                ...
                for batch_idx, (data, label, index) in enumerate(process):
                    ...
                    loss_values.append(loss.item())
                    with open("abcde.txt", 'a') as f:
                        f.write(str(output.data.tolist()))
...
def main():
    ...
    if p.config is not None:
        print("/home/salman/msg3d_exp/handpose/msg3d/" + p.config)
        with open( "/home/salman/msg3d_exp/handpose/msg3d/" +  p.config, 'r') as f:

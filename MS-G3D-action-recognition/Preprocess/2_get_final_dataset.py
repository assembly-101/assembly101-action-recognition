...
if __name__ == '__main__':
    ...
    # Take parent directory of the directory for segment wise pickle files for handpose frames 
    # generated by 1_generate_pose_data.py
    main_path = '/home/salman/msg3d_exp/handpose/HAND_GCN/'
    ...
    for _max_frame in list_max_frames:
        ...
        parser.add_argument('--data_path', default=main_path + '/RAW_contex25_thresh0/')
        parser.add_argument('--out_folder', default=main_path + '/share_contex25_thresh0/')
        ...
        for p in part:
            ...
            gendata(data_path, arg.out_folder, _max_frame, part=p)
